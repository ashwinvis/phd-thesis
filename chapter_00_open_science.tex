...
%
The FOSS culture can be traced back to the success of the type-setting
...
%
To summarize, Python's many features and its adoption in several domains
...
\item \textbf{Concurrent, but not parallel multi-threading.} Threads behave
	...
	}. In other words, threads can coexist concurrently, by not execute in
	parallel.
%
