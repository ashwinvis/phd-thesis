...
In the present work, through FluidDyn project, we have managed to implement all
...
\paragraphbf{Continuous integration (CI)} The need for strong reliability of
...
\paragraphbf{Websites to share knowledge} Mutual aid and knowledge sharing
...
\paragraphbf{Automatic web documentations built on servers} Documentation
