...
%-------------------------------------------------------------------------------
%
\title[Studies in Geophysical Fluid Mechanics]% Title used in the abstract (optional)
{% Title of the thesis
	Studies in \\ Geophysical Fluid Mechanics
        % or \\
        % Scales and Energetics of Geophysical Turbulence%
}%
...
{% Swedish title (for swedish abstract)
    Studier i \\ Geofysikalisk Strömnmekanik
}%
...
\includeonly{paper_03_toy_model/paper}
