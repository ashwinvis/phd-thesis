...
%
\title[%
  Advancing stratified flows through simulations, experiments and open research software development%
]% Title used in the abstract (optional)
{% Title of the thesis
  Advancing stratified flows through \\ simulations, experiments and open
...
{% Swedish title (for swedish abstract)
  Fr\"amja stratifierade fl\"oden genom simuleringar, experiment och
